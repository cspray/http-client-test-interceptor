 ...
 */
final class UriPathMatcherTest extends MatcherStrategyTestCase {
    ...
    protected function request() : Request {
        return new Request('http://example.com/path/foo/bar');
    }

    protected function matchingFixture() : Fixture {
        return StubFixture::fromRequest(new Request('http://example.com/path/foo/bar'));
    }

    protected function nonMatchingFixture() : Fixture {
        return StubFixture::fromRequest(new Request('http://example.com/path/foo/baz'));
    }
